...
src/Lib/xUtilities/%.o: ../src/Lib/xUtilities/%.c src/Lib/xUtilities/subdir.mk
	...
	gcc -DRELEASE -D__LINUX__ -I$(SOURCE_PATH)/src/xLib -I$(SOURCE_PATH)/src -O0 -g3 -Wall -c -fmessage-length=0 -Wno-unknown-pragmas -DVERSION=$(VERSION_STRING) -DBUILD=$(BUILD_HASH) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
