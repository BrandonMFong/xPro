...
src/External/lib/clib/%.o: ../src/External/lib/clib/%.c src/External/lib/clib/subdir.mk
	...
	gcc -DRELEASE -D__MACOS__ -I$(SOURCE_PATH)/src/Lib -I$(SOURCE_PATH)/src/External/lib/clib -I$(SOURCE_PATH)/src -O0 -g3 -Wall -c -fmessage-length=0 -DVERSION=$(VERSION_STRING) -DBUILD=$(BUILD_HASH) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
