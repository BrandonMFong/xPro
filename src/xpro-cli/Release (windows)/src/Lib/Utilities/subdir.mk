...
src/Lib/Utilities/%.o: ../src/Lib/Utilities/%.c src/Lib/Utilities/subdir.mk
	...
	gcc -DRELEASE -D__WINDOWS__ -I"$(SOURCE_PATH)\src\Lib" -I"$(SOURCE_PATH)\src" -O0 -g3 -Wall -c -fmessage-length=0 -Wno-unknown-pragmas -DVERSION=$(VERSION_STRING) -DBUILD=$(BUILD_HASH) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
