...
src/Lib/Utilities/%.o: ../src/Lib/Utilities/%.c src/Lib/Utilities/subdir.mk
	...
	gcc -DDEBUG -DTESTING -D__LINUX__ -I$(SOURCE_PATH)/src -I$(SOURCE_PATH)/src/Lib -O0 -g3 -Wall -c -fmessage-length=0  -Wno-unknown-pragmas -DVERSION=$(VERSION_STRING) -DBUILD=$(BUILD_HASH) -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -o "$@" "$<"
